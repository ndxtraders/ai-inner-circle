    ...
    <footer className="border-t border-rule bg-paper-grey">
      <div className="max-w-wide mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-small text-ink-muted">
        ...
        <div className="flex items-center gap-6">
          <Link href="https://revvaughn.com/resources" className="hover:text-ink transition-colors">
            Resources
          </Link>
          <Link href="https://revvaughn.com/contact" className="hover:text-ink transition-colors">
            Contact
          </Link>
