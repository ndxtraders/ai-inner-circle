  ...
  return (
    <>
        ...
        <Section bg="paper" width="prose">
          ...
          <p className="text-small text-ink-muted">Jan 30, 2026 &middot; 5 min read</p>
        </Section>
        ...
        <Section bg="paper" width="prose">
          <div className="space-y-6 text-body text-ink leading-relaxed">
            ...
            <ol className="space-y-2 list-decimal pl-6">
              ...
              <li><strong>Your setup time.</strong> The self-built tier trades dollars for hours. Count them honestly: a working first agent is a weekend.</li>
            </ol>
            ...
            <ul className="space-y-2">
              ...
              <li><strong>The problem is often a decision you haven&rsquo;t made yet.</strong> Mispriced offer, wrong niche, unclear positioning: an agent will automate the symptom and leave the decision untouched.</li>
            </ul>
